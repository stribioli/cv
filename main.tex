...
\begin{entrylist}
	\entry
		...
		{Milan, Italy}
		{
			...
			\\
			I have been managing projects worth around 600 k€ of annual revenue and I have been personally involved in the sale of about half of them.
			\\
			\\
			...
			\\
			The goal is to detect and block insider threats (fraud and data exfiltration), analyzing the behavioral patterns of agents.
			The system consists of a custom Go module and a Redis cluster, for real-time decisions. Custom Python scripts and a MySQL database are used for historical analytics. A Layer7 API Gateway handles the production traffic.
			\\
			\\
